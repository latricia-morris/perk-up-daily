  ...
  if (featured) {
    return (
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(201,127,14,0.12) 0%, #fffdf8 60%)',
          border: '1px solid rgba(201,127,14,0.22)',
          boxShadow: '0 4px 24px rgba(201,127,14,0.10)',
        }}
      >
        {/* We asked */}
        <div
          className="px-6 pt-6 pb-4"
          style={{ borderBottom: '1px solid rgba(201,127,14,0.1)' }}
        >
          <div className="flex items-center gap-1.5 mb-2">
            <Sparkles className="w-3 h-3" style={{ color: '#C97F0E' }} />
            <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: '#C97F0E' }}>We asked:</span>
          </div>
        ...
        <div className="px-6 py-5">
          <p className="text-[10px] font-bold uppercase tracking-widest mb-3" style={{ color: '#A86A0A' }}>You said:</p>
          ...
          <div className="mt-5">
            <Button
              ...
              size="sm"
              className="gap-2"
              style={{ background: 'rgba(201,127,14,0.12)', color: '#A86A0A', border: '1px solid rgba(201,127,14,0.25)' }}
            >
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 mb-2.5">
        <Sparkles className="w-3 h-3" style={{ color: '#C97F0E' }} />
        <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: '#A86A0A' }}>Reflection</span>
      </div>
