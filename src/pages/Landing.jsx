        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: BookOpen, title: 'Faith-friendly content', desc: 'If faith is part of your life, you can turn on Christian content to receive scriptures and access the Deep Faith category whenever you want it. If not, you are still welcome to enjoy the uplifting experience our app provides.' },
